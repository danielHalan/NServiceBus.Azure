...
namespace Subscriber
{
    class Program
    {
        ...
        private static void StartReceiving(string primaryNamespace, string secondaryNamespace, string id)
        {
            ...
            var primary = MessagingFactory.CreateFromConnectionString(primaryNamespace);
            var secondary = MessagingFactory.CreateFromConnectionString(secondaryNamespace);

            var sendAvailabilityOptions = new SendAvailabilityPairedNamespaceOptions(secondaryNamespaceManager, secondary);
